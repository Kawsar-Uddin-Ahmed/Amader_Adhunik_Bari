...
if(isset($_GET['ufid']))
{
    $blockid =  preg_replace('/[^-a-zA-Z0-9_]/','.',$_GET['ufid']);
    $bl = $fetch->userunblock($blockid);
...
if(isset($_GET['ppidg']))
{
    $penid =  preg_replace('/[^-a-zA-Z0-9_]/','.',$_GET['ppidg']);
    $pen1 = $fetch->pendingaccount($penid);
...
?>
						...
						<tr class="odd gradeX">
							...
							<td><a href="usershow.php?osid=<?php echo $result['owner_id'];?>">Show</a> || <a onclick="return confirm('Are your sure to delete');" href="?owdelid=<?php echo $result['flat_code'];?>">Delete</a>|| <a href="userblock.php?ofid=<?php echo $result['flat_code'];?>">Block</a></td>
						</tr>
						<?php
                         }
                          }
