...
if(isset($_GET['ofid']))
{
    $blockid =  preg_replace('/[^-a-zA-Z0-9_]/','.',$_GET['ofid']);
    $bl = $fetch->userblock($blockid);
...
?>
                        ...
                        <tr class="odd gradeX">
                           ...
                           <td><?php echo $result['gender'];?></td>
                            ...
                            <td><a onclick="return confirm('Are your sure to delete');" href="?owdelid=<?php echo $result['flat_code'];?>">Delete</a>|| <a href="userlist.php?ufid=<?php echo $result['flat_code'];?>">Unblock</a></td>
                        </tr>
                        <?php
                         }
                          }
