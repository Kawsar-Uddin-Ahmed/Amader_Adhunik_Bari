...
include "class/owner_user_data.php";
...
?>  
          ...
          <option>Owner</option>
                  ...
                  <input type="text" name="bname" placeholder="Your building name" required=""><br>
                    <input type="text" name="flat_no" placeholder="Flat name" required=""><br>

                      <input type="text" name="flat_code" placeholder="Write your flat code" required=""><br>
                      
                     <!--<select name="zone_name">
					<option>Select zone</option>
					     <?php
                                  /*$zonename = $logrent->zoning();
                                 if($zonename)
                                 {
                                    //$i=0;
                                  
                                while($result = $zonename->fetch_assoc())
                                    {
                                        //$i++;

                                ?>
                                    <option value="<?php echo $result['zoid']; //$i; ?>"><?php echo $result['zonename']; ?></option>
                                   <?php } } */?>
                               </select>-->
                          <input type="text" name="zone_name" placeholder="Write zone name.Link given bellow" required=""><br>


                      <input type="hidden" name="state" required readonly value="0"><br>
		...
		<div class="colorlibcopy-agile">
			<p>© 2021 Signup Form. All rights reserved | Design by <a href="#" target="_blank">Kawsar & Avishek</a></p>
		</div>
		<!-- //copyright -->
